...
class RNNCell(tf.contrib.rnn.RNNCell): # adjust this for tensorflow V 1.0.1 (possibly earlier on as well)
    ...
    def __call__(self, inputs, state, output=None, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            b   = tf.get_variable('b',   initializer=tf.contrib.layers.xavier_initializer(), shape=(self.state_size) )
