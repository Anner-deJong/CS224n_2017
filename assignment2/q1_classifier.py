...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder  = tf.placeholder(dtype=tf.float32, shape=(self.config.batch_size,
                                                                          self.config.n_features))
        self.labels_placeholder = tf.placeholder(dtype=tf.int32,   shape=[self.config.batch_size,
    ...
    def fit(self, sess, inputs, labels):
        ...
        for epoch in range(self.config.n_epochs):
            ...
            print('Epoch %2i: loss = %4.2f (%.3f sec)' % (epoch, average_loss, duration))
